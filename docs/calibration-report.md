...
模型预测误差 4.1 个月，**方向正确但精度有待提升**。

---

## Leave-one-out 交叉验证

| Fold | 留出案例 | 训练评分 | 实际领先(月) | 预测领先(月) | 误差(月) |
|------|---------|---------|-------------|-------------|---------|
| 1 | Stable Diffusion 爆发 | 0.765 | 6.1 | 7.2 | 1.1 |
| 2 | ChatGPT 爆发 | 0.765 | 16.5 | 5.9 | 10.6 |
| 3 | Local LLM 爆发 | 0.791 | 5.2 | 5.4 | 0.2 |
| 4 | RAG / Vector DB 爆发 | 0.789 | 12.4 | 7.9 | 4.5 |
| 5 | Cursor / AI IDE 爆发 | 0.775 | 1.1 | 6.1 | 5.0 |
| 6 | Manus / 通用 Agent 爆发 | 0.747 | 5.1 | 4.3 | 0.8 |

**平均预测误差: 3.7 个月** (6 个有效 fold)
**残差标准差: ±5.4 个月**
**预测偏差: -1.6 个月** (偏晚)
...
|------|---------|
| 点估计 | **2025-01-29** |
| 68% 区间 (±1σ) | 2024-08-21 ~ 2025-07-09 |
| 95% 区间 (±2σ) | 2024-03-13 ~ 2025-12-17 |
| 实际爆发 | 2025-06-01 |
